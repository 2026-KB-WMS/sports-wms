    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/orders/stores/my").hasRole("USER")
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.PATCH, "/api/inbounds/*/details/*/section/clear").hasRole("WAREHOUSE_MANAGER")
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.PATCH, "/api/outbounds/*/details/*/section/clear").hasRole("WAREHOUSE_MANAGER")
